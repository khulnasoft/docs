...
export default function Home() {
	...
	return (
		<Layout description="Here you'll find documentation and reference material for monitoring and troubleshooting your systems with Khulnasoft.">
			<HomepageHeader />
			<main className="container">
				<Grid className="mb-16" columns="2">
					<Box
						to="/docs/khulnasoft-agent/installation/"
						title="Get started"
						cta="Install now"
						image={true}
					>
					...
					<Box to="/docs/deployment-guides" title="Docs" cta="Read the docs" image={false}>
						Solution- and action-based docs for Khulnasoft's many features and
						capabilities. Your table of contents to becoming an expert in using
						Khulnasoft to monitor and troubleshoot applications and their
						infrastructure.
					</Box>
				</Grid>
				<div id="updates" className="relative flex flex-row flex-wrap pb-12">
					...
					<div className="flex-1 markdown prose-lg ml-0 lg:ml-8 mt-16">
						...
						<p>
							Read the{' '}
							<Link
								to={`https://github.com/khulnasoft/khulnasoft/releases/tag/v${ReleaseVersion}`}
							>
								release notes
							</Link>{' '}
							or{' '}
							<Link to="/docs/khulnasoft-agent/maintenance/update-khulnasoft-agents">
								{' '}
								update now
							</Link>
							.
