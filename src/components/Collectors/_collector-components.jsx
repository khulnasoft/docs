	...
	return (
		<>
			...
			<ol>
				<li>
					Navigate to the{' '}
					<a href="/docs/configure/nodes#the-khulnasoft-config-directory">
						Khulnasoft config directory
					</a>
					.<CodeBlock className="bash">cd /etc/khulnasoft</CodeBlock>
				</li>
				<li>
					Use the{' '}
				...
				<li>
					...
					<code>sudo systemctl restart khulnasoft</code> or the{' '}
		...
		<>
			...
			<ol>
				<li>
					...
					<code>/usr/libexec/khulnasoft/plugins.d/</code>. If that's not the case
					on your system, open <code>khulnasoft.conf</code> and look for the
					setting <code>plugins directory</code>.{' '}
				</li>
				<li>
					In the plugins directory, switch to the <code>khulnasoft</code> user.
					<CodeBlock className="bash">
						cd /usr/libexec/khulnasoft/plugins.d/ sudo -u khulnasoft -s
					</CodeBlock>{' '}
				</li>
