...
# This script is intended for users who want to build a customized docker-compose.yml for CyberPot.
# CyberPot Service Builder will ask for all the docker services to be included in docker-compose.yml.
...
config_filename = "cyberpot_services.yml"
