...
app.conf.beat_schedule = {
    # every 10 minutes
    "extract_log4pot": {
        "task": "threatpot.tasks.extract_log4pot",
        "schedule": crontab(minute="*/10"),
        "options": {"queue": "default"},
    },
    # every 10 minutes
    "extract_cowrie": {
        "task": "threatpot.tasks.extract_cowrie",
        "schedule": crontab(minute="*/10"),
        "options": {"queue": "default"},
    },
    # FEEDS
    # every 10 minutes
    "extract_general": {
        "task": "threatpot.tasks.extract_general",
        "schedule": crontab(minute="*/10"),
        "options": {"queue": "default"},
    },
    # once a day
    "extract_sensors": {
        "task": "threatpot.tasks.extract_sensors",
        "schedule": crontab(hour=0),
        "options": {"queue": "default"},
    },
    # once an hour
    "monitor_honeypots": {
        "task": "threatpot.tasks.monitor_honeypots",
        "schedule": crontab(minute=18),
        "options": {"queue": "default"},
    },
    # once an hour
    "monitor_logs": {
        "task": "threatpot.tasks.monitor_logs",
