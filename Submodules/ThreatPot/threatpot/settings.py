...
DJANGO_LOG_DIRECTORY = "/var/log/threatpot/django"
...
VERSION = os.environ.get("REACT_APP_THREATPOT_VERSION", "")
...
INSTALLED_APPS = [
    ...
    # threatpot apps
    "threatpot.apps.ThreatPotConfig",
    "authentication",
    # auth
    "rest_email_auth",
]

# required by the certego-saas, but ThreatPot doesn't use the recaptcha, for this reason is filled with a placeholder
...
REST_DURIN = {
    ...
    "API_ACCESS_CLIENT_NAME": "pythreatpot",
...
REST_EMAIL_AUTH = {
    ...
    "EMAIL_SUBJECT_VERIFICATION": "ThreatPot - Please Verify Your Email Address",
    "EMAIL_SUBJECT_DUPLICATE": "ThreatPot - Registration Attempt",
...
WSGI_APPLICATION = "threatpot.wsgi.application"

DEFAULT_AUTO_FIELD = "django.db.models.BigAutoField"

DB_HOST = os.environ.get("DB_HOST")
DB_PORT = os.environ.get("DB_PORT")
DB_NAME = os.environ.get("DB_NAME", "threatpot_db")
...
LOGGING = (
    {
        ...
        "handlers": {
            ...
            "threatpot": {
                "level": INFO_OR_DEBUG_LEVEL,
                "class": "logging.handlers.WatchedFileHandler",
                "filename": f"{DJANGO_LOG_DIRECTORY}/threatpot.log",
                "formatter": "stdfmt",
            },
            "threatpot_error": {
                "level": "ERROR",
                "class": "logging.handlers.WatchedFileHandler",
                "filename": f"{DJANGO_LOG_DIRECTORY}/threatpot_errors.log",
                "formatter": "stdfmt",
            },
        ...
        "loggers": {
            ...
            "threatpot": {
                "handlers": ["threatpot", "threatpot_error"],
                "level": INFO_OR_DEBUG_LEVEL,
                "propagate": True,
            },
            "django": {
