...
import { THREATPOT_DOCS_URL } from "../../../constants/environment";
...
export function InviteOnlyAlert() {
  return (
    ...
    >
      ...
      <p>
        Please note that ThreatPot is operated as an invite-only trust group.
        ...
        <>
          <section>
            <Alert color="success" className="text-center">
              <h3>Thank you for signing up on ThreatPot! 🤝</h3>
            </Alert>
          </section>
        ...
        <>
          ...
          <section className="mt-4">
            <p>
              ...
              <a href={THREATPOT_DOCS_URL} target="_blank" rel="noreferrer">
                documentation
              </a>{" "}
