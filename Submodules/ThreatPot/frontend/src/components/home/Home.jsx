...
const logoBgImg = `url('${PUBLIC_URL}/threatpot.png')`;
const blogPosts = [
  {
    title: "New project available: ThreatPot",
    subText: "Honeynet Blog: Official announcement",
    date: "27th December 2021",
    link: "https://www.honeynet.org/2021/12/27/new-project-available-threatpot/",
  },
];
  ...
  return (
    <>
      ...
      <Container id="home__content" className="mt-2">
        ...
        <br />
        {/* blogPosts */}
        <h5 className="text-gradient">ThreatPot News</h5>
        <ContentSection>
