...
description: 'Learn how to use Teleflow to quickly send multi-channel (SMS, Email, Chat, Push) notifications with Python.'
icon: 'python'
---

In this guide, you'll learn how to use Teleflow in a Python application. Let's see how you can seamlessly integrate Teleflow into your Python project!
...
- A Teleflow account. If you don't have one, sign up for free at [web.teleflow.khulnasoft.com](https://web.teleflow.khulnasoft.com?utm_campaign=docs-gs-quick-python)

## Install and Set Up Teleflow in your Python Project

First, you must install the Teleflow package in your Python project. From your terminal, you can install the Teleflow package in your project by running either of the following two commands:
...
TeleflowConfig().configure("https://api.teleflow.khulnasoft.com", "<TELEFLOW_API_KEY>")

```

Replace the `<TELEFLOW_API_KEY>` value with the authentic key from the **API Key** section of your [Teleflow Dashboard](https://web.teleflow.khulnasoft.com/settings?utm_campaign=docs-quick-python).

<Note>Please do not hardcode your credentials in a file in production. Use environment variables instead.</Note>
...
5. Select any channel you want to use in your app. For the sake of this guide, we'll be using the 'Email' channel.
   <Frame>
      <img src="https://res.cloudinary.com/dxc6bnman/image/upload/v1686776583/set-email_wavtrn.png" alt="Set email" />
   </Frame>

6. Click on the recently added channel, fill the email subject and click “Update”.
   <Frame>
      <img src="https://res.cloudinary.com/dxc6bnman/image/upload/v1686776583/update_email_template_ivn0jv.png" alt="Update email template" />
   </Frame>

7. Click on the “Test” tab and send a test email to verify your notification workflow.
   <Frame>
      <img src="https://res.cloudinary.com/dxc6bnman/image/upload/v1686776583/send_test_email_ngzmth.png" alt="Send test email" />
   </Frame>
...
Click **Subscribers** on the left sidebar of the Teleflow dashboard to see all subscribers. By default, the dashboard will display only one subscriber, as you were added automatically during sign-up. If default subscriber is not created, checkout [how to create new subscriber.](/subscribers/subscribers#create-a-subscriber)
...
<Note>To send notifications to all your users, you'll need to make them subscribers in Teleflow, which you can do by programmatically adding them to Teleflow.</Note>
...
<Frame>
   <img src="https://res.cloudinary.com/dxc6bnman/image/upload/v1686776585/trigger_id_xkhsx7.png" alt="Trigger id" />
</Frame>
...
- The value of `recipients` is the id of the subscriber on Teleflow. Replace `123` with your subscriber ID.
...
<Note>The topic key should be unique and can't be changed once chosen. Teleflow also safe guards for key uniqueness behind the scenes.</Note>
...
- [Teleflow Digest Engine](/workflows/digest) - Learn how to aggregate multiple trigger events into a single message and deliver it to the subscriber.
- [Teleflow Python SDK](https://github.com/khulnasoft/teleflow-python) - Delve deeper into the SDK and explore a lot of features.
- [Teleflow Python Cookbook](https://teleflow-python.readthedocs.io/en/latest/) - Learn how to use the SDK features.
