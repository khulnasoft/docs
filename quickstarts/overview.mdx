---
title: "Quickstarts"
description: "Learn how to use Teleflow to quickly send multi-channel (SMS, Email, Chat, Push) notifications with any language/framework of your choice."
---
...
<CardGroup cols={3}>
  ...
  <Card title="Node.js" icon="node" color="#16a34a" href="/quickstarts/nodejs">
    Connect a Node.js application to Teleflow.
  </Card>
  <Card title="PHP" icon={
    ...
    Connect a PHP application to Teleflow.
  </Card>
  <Card title="Python" icon={
    ...
    Connect a Python application to Teleflow.
  </Card>
  <Card
    title="Kotlin"
    icon={
  ...
  >
    Connect a Kotlin application to Teleflow.
  </Card>
  <Card
    title="Ruby"
    icon={
...
>
    ...
    Connect a Ruby application to Teleflow.
  ...
  <Card title=".NET" icon={
    ...
    Connect a .NET application to Teleflow.
  </Card>
  <Card
    title="NextJS"
    icon={
  ...
  >
    Connect a NextJS application to Teleflow.
  </Card>
  <Card title="Go" icon="golang" color="#00D7FE" href="/quickstarts/go">
    Connect a Go application to Teleflow.
  </Card>
  <Card title="Java" icon={
    ...
    Connect a Java application to Teleflow.
  </Card>
</CardGroup>
