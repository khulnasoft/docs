...
Currently, Teleflow supports the following customizations:
...
Tenants can be created and modified via the [API](http://docs.teleflow.khulnasoft.com/api-reference/tenants/get-tenants) or [Web](https://web.teleflow.khulnasoft.com/tenants?utm_campaign=docs-tenants). Each tenant can have multiple fields on it:
...
To create a tenant on the Teleflow web platform, follow these steps:
...
When triggering a workflow, it is possible to pass the tenant information (id or object, in case of an object, teleflow will upsert the tenant if it’s not existing) like so:
...
<Frame caption="Add provider instance"><img src="https://github.com/khulnasoft/docs/assets/2946769/583824c7-766b-49fc-bb8e-7cf72dd74eee" /></Frame>

<Frame caption="Set conditions"><img src="https://github.com/khulnasoft/docs/assets/2946769/9c1c33f5-f5eb-4e4b-82b7-f4c05bdf00d7" /></Frame>
...
<Frame caption="Add variant"><img src="https://github.com/khulnasoft/docs/assets/2946769/0ca3c7a8-b046-4db5-bb48-b2894d313a35" /></Frame>

- It opens up the condition page. Set the tenant identifier to equal "JohnDoe".
<Frame caption="Set variant"><img src="https://github.com/khulnasoft/docs/assets/2946769/c6306feb-5126-47da-8d83-8e01755a3ade" /></Frame>

- Apply Conditions as shown above.
- Check the email step in the workflow, you'll see the **root variant** and **v1 variant**.
<Frame caption="See the variants"><img src="https://github.com/khulnasoft/docs/assets/2946769/d8570463-270e-41a3-be96-e33c178750c3" /></Frame>

Once a trigger runs, the Teleflow engine checks to see if there's a `tenant` identifier specified in the trigger code.
