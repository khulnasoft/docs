---
custom_edit_url: "https://github.com/khulnasoft/khulnasoft/edit/master/docs/developer-and-contributor-corner/collect-apache-nginx-web-logs.md"
sidebar_label: "Monitor Nginx or Apache web server log files with Khulnasoft"
docs_status: "Published"
docs_rel_path: "Developer and Contributor Corner"
sidebar_position: "1614070"
docs_link: "https://docs.khulnasoft.com/docs/developer-and-contributor-corner/monitor-nginx-or-apache-web-server-log-files-with-khulnasoft"
---

# Monitor Nginx or Apache web server log files

Parsing web server log files with Khulnasoft, revealing the volume of redirects, requests and other metrics, can give you a better overview of your infrastructure.
...
The [web_log](/docs/collecting-metrics/web-servers-and-web-proxies/web-server-log-files) collector is currently compatible
...
As with all data sources, Khulnasoft can auto-detect Nginx or Apache servers if you installed them using their standard
...
Restart Khulnasoft with `sudo systemctl restart khulnasoft`, or the [appropriate method](/docs/khulnasoft-agent/maintenance/service-control) for your system. Khulnasoft should pick up your web server's access log and begin showing real-time charts!
...
We do have [extensive documentation](/docs/collecting-metrics/web-servers-and-web-proxies/web-server-log-files) on how to build custom parsing for Nginx and Apache logs.
...
- [web log alerts](https://raw.githubusercontent.com/khulnasoft/khulnasoft/master/src/health/health.d/web_log.conf).
...
[health monitoring documentation](/docs/alerts-&-notifications).
