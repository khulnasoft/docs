---
custom_edit_url: "https://github.com/khulnasoft/khulnasoft/edit/master/src/web/api/queries/percentile/README.md"
...
sidebar_position: "1602580"
docs_link: "https://docs.khulnasoft.com/docs/developer-and-contributor-corner/rest-api/queries/percentile"
---
...
Khulnasoft applies linear interpolation on the last point, if the percentile requested does not give a round number of
points.
...
-   ![](https://registry.my-khulnasoft.io/api/v1/badge.svg?chart=web_log_nginx.response_statuses&options=unaligned&dimensions=success&group=percentile95&after=-60&label=percentile95&value_color=orange)
