---
custom_edit_url: "https://github.com/khulnasoft/khulnasoft/edit/master/src/web/api/queries/des/README.md"
...
sidebar_position: "1602530"
docs_link: "https://docs.khulnasoft.com/docs/developer-and-contributor-corner/rest-api/queries/double-exponential-smoothing"
---
...
Khulnasoft automatically adjusts the weight (`alpha`) and the trend (`beta`) based on the number
...
-   ![](https://registry.my-khulnasoft.io/api/v1/badge.svg?chart=web_log_nginx.response_statuses&options=unaligned&dimensions=success&group=ses&after=-60&label=single+exponential+smoothing&value_color=yellow)
-   ![](https://registry.my-khulnasoft.io/api/v1/badge.svg?chart=web_log_nginx.response_statuses&options=unaligned&dimensions=success&group=des&after=-60&label=double+exponential+smoothing&value_color=orange)
