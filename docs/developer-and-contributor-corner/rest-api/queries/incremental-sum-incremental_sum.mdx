---
custom_edit_url: "https://github.com/khulnasoft/khulnasoft/edit/master/src/web/api/queries/incremental_sum/README.md"
...
sidebar_position: "1602540"
docs_link: "https://docs.khulnasoft.com/docs/developer-and-contributor-corner/rest-api/queries/incremental-sum-(`incremental_sum`)"
---
...
-   ![](https://registry.my-khulnasoft.io/api/v1/badge.svg?chart=web_log_nginx.response_statuses&options=unaligned&dimensions=success&group=incremental_sum&after=-60&label=incremental+sum&value_color=orange)
