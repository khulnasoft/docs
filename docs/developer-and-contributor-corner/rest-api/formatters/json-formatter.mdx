---
custom_edit_url: "https://github.com/khulnasoft/khulnasoft/edit/master/src/web/api/formatters/json/README.md"
sidebar_label: "JSON formatter"
docs_status: "Published"
docs_rel_path: "Developer and Contributor Corner/REST API/Formatters"
sidebar_position: "1603020"
docs_link: "https://docs.khulnasoft.com/docs/developer-and-contributor-corner/rest-api/formatters/json-formatter"
---

# JSON formatter

The CSV formatter presents [results of database queries](/docs/developer-and-contributor-corner/rest-api/queries) in the following formats:
...
```bash
# curl -Ss 'https://registry.my-khulnasoft.io/api/v1/data?chart=nginx_local.connections&after=-3600&points=6&group=average&format=json&options='
{
 "labels": ["time", "active"],
    "data":
 [
...
```bash
# curl -Ss 'https://registry.my-khulnasoft.io/api/v1/data?chart=nginx_local.connections&after=-3600&points=6&group=average&format=json&options=objectrows'
{
 "labels": ["time", "active"],
    "data":
 [
...
```bash
# curl -Ss 'https://registry.my-khulnasoft.io/api/v1/data?chart=nginx_local.connections&after=-3600&points=6&group=average&formatjson&options=objectrows,google_json'
{
 "labels": ["time", "active"],
    "data":
 [
...
```bash
curl -Ss 'https://registry.my-khulnasoft.io/api/v1/data?chart=nginx_local.connections&after=-3600&points=6&group=average&formjsonp&options='
callback({
 "labels": ["time", "active"],
    "data":
 [
...
```bash
curl -Ss 'https://registry.my-khulnasoft.io/api/v1/data?chart=nginx_local.connections&after=-3600&points=6&group=average&formdatatable&options='
{
 "cols":
 [
...
```bash
curl -Ss 'https://registry.my-khulnasoft.io/api/v1/data?chart=nginx_local.connections&after=-3600&points=6&group=average&format=datasource&options='
