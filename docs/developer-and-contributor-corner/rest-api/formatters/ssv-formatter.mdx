---
custom_edit_url: "https://github.com/khulnasoft/khulnasoft/edit/master/src/web/api/formatters/ssv/README.md"
sidebar_label: "SSV formatter"
docs_status: "Published"
docs_rel_path: "Developer and Contributor Corner/REST API/Formatters"
sidebar_position: "1603030"
docs_link: "https://docs.khulnasoft.com/docs/developer-and-contributor-corner/rest-api/formatters/ssv-formatter"
---

# SSV formatter

The SSV formatter sums all dimensions in [results of database queries](/docs/developer-and-contributor-corner/rest-api/queries)
...
```bash
# curl -Ss 'https://registry.my-khulnasoft.io/api/v1/data?chart=system.cpu&format=ssv&after=-3600&points=6&group=average'
...
Khulnasoft returns bandwidth in `kilobits`.

```bash
# curl -Ss 'https://registry.my-khulnasoft.io/api/v1/data?chart=mysql_local.net&format=ssvcomma&after=-3600&points=6&group=sum&options=abs'
...
```bash
# curl -Ss 'https://registry.my-khulnasoft.io/api/v1/data?chart=nginx_local.connections&format=array&after=-3600&points=12&group=max'
