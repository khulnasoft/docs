---
custom_edit_url: "https://github.com/khulnasoft/khulnasoft/edit/master/src/libkhulnasoft/worker_utilization/README.md"
sidebar_label: "Worker Utilization"
docs_status: "Published"
docs_rel_path: "Developer and Contributor Corner/libkhulnasoft"
sidebar_position: "1612210"
docs_link: "https://docs.khulnasoft.com/docs/developer-and-contributor-corner/libkhulnasoft/worker-utilization"
---
...
of the worker, the statistics collector of khulnasoft will calculate if the thread is
...
The statistics collector is called by the telemetry thread of khulnasoft. So,
even if the workers are extremely busy with their jobs, khulnasoft will be able to know
how busy they are.
