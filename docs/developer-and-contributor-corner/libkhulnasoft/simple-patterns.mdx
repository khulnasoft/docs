---
custom_edit_url: "https://github.com/khulnasoft/khulnasoft/edit/master/src/libkhulnasoft/simple_pattern/README.md"
sidebar_label: "Simple patterns"
docs_status: "Published"
docs_rel_path: "Developer and Contributor Corner/libkhulnasoft"
description: "Khulnasoft supports simple patterns, which are less cryptic versions of regular expressions. Use familiar notation for powerful results."
sidebar_position: "1612150"
docs_link: "https://docs.khulnasoft.com/docs/developer-and-contributor-corner/libkhulnasoft/simple-patterns"
---
...
So, Khulnasoft supports **simple patterns**.
...
You can use the Khulnasoft command line to check simple patterns,
like this:

```sh
# khulnasoft -W simple-pattern '*foobar* !foo* !*bar *' 'hello world'
RESULT: MATCHED - pattern '*foobar* !foo* !*bar *' matches 'hello world'

# khulnasoft -W simple-pattern '*foobar* !foo* !*bar *' 'hello world bar'
RESULT: NOT MATCHED - pattern '*foobar* !foo* !*bar *' does not match 'hello world bar'

# khulnasoft -W simple-pattern '*foobar* !foo* !*bar *' 'hello world foobar'
RESULT: MATCHED - pattern '*foobar* !foo* !*bar *' matches 'hello world foobar'
```

Khulnasoft stops processing to the first positive or negative match
