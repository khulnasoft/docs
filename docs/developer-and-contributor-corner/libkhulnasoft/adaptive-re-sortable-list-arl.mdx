---
custom_edit_url: "https://github.com/khulnasoft/khulnasoft/edit/master/src/libkhulnasoft/adaptive_resortable_list/README.md"
...
sidebar_position: "1612010"
docs_link: "https://docs.khulnasoft.com/docs/developer-and-contributor-corner/libkhulnasoft/adaptive-re-sortable-list-(arl)"
---

# Adaptive Re-sortable List (ARL)

This library allows Khulnasoft to read a series of `name - value` pairs
in the **fastest possible way**.

ARLs are used all over Khulnasoft, as they are the most
...
-   before ARL Khulnasoft was using test No **7** with hashing and a custom `str2ull()` to achieve 602ms.
...
[Check the source code of this test](https://raw.githubusercontent.com/khulnasoft/khulnasoft/master/tests/profile/benchmark-value-pairs.c).
