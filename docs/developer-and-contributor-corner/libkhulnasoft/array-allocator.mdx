---
custom_edit_url: "https://github.com/khulnasoft/khulnasoft/edit/master/src/libkhulnasoft/aral/README.md"
sidebar_label: "Array allocator"
docs_status: "Published"
docs_rel_path: "Developer and Contributor Corner/libkhulnasoft"
sidebar_position: "1612020"
docs_link: "https://docs.khulnasoft.com/docs/developer-and-contributor-corner/libkhulnasoft/array-allocator"
---

# Array Allocator

Come on! Array allocators are embedded in libc! Why do we need such a thing in Khulnasoft?

Well, we have a couple of problems to solve:

1. **Fragmentation** - It is important for Khulnasoft to keeps its overall memory footprint as low as possible. libc does an amazing job when the same thread allocates and frees some memory. But it simply cannot do better without knowing the specifics of the application when memory is allocated and freed randomly between threads.
2. **Speed** - Especially when allocations and de-allocations happen across threads, the speed penalty is tremendous.

In Khulnasoft we have a few moments that are very tough. Imagine collecting 1 million metrics per second. You have a buffer for each metric and put append new points there. This works beautifully, of course! But then, when the buffers get full, imagine the situation. You suddenly need 1 million buffers, at once!
...
So solve it, Khulnasoft uses a special implementation of an array allocator that is tightly integrated with the structures we need.
...
3. Optional defragmenter, that once enabled it will make free operation slower while trying to maintain a sorted list of fragments to offer first during allocations. The defragmenter can be enabled / disabled at run time. The defragmenter can hurt performance on application with intense turn-around of allocation, like Khulnasoft dbengine caches. So, it is disabled by default.
...
2023-01-29 17:04:50: khulnasoft INFO  : TH[0] : set name of thread 1314983 to TH[0]
...
2023-01-29 17:04:55: khulnasoft INFO  : MAIN : ARAL: did 61487356 malloc, 61487356 free, using 1 threads, in 5003808 usecs
```
...
2023-01-29 17:05:25: khulnasoft INFO  : TH[0] : set name of thread 1315537 to TH[0]
2023-01-29 17:05:25: khulnasoft INFO  : TH[1] : set name of thread 1315538 to TH[1]
...
Waiting the threads to finish...
2023-01-29 17:05:30: khulnasoft INFO  : MAIN : ARAL: did 90976190 malloc, 90976190 free, using 2 threads, in 5029462 usecs
```
...
2023-01-29 17:10:12: khulnasoft INFO  : TH[0] : set name of thread 1319552 to TH[0]
2023-01-29 17:10:12: khulnasoft INFO  : TH[1] : set name of thread 1319553 to TH[1]
2023-01-29 17:10:12: khulnasoft INFO  : TH[2] : set name of thread 1319554 to TH[2]
2023-01-29 17:10:12: khulnasoft INFO  : TH[3] : set name of thread 1319555 to TH[3]
...
Waiting the threads to finish...
2023-01-29 17:10:17: khulnasoft INFO  : MAIN : ARAL: did 103549747 malloc, 103549747 free, using 4 threads, in 5023325 usecs
```
...
2023-01-29 17:07:06: khulnasoft INFO  : TH[0] : set name of thread 1317608 to TH[0]
2023-01-29 17:07:06: khulnasoft INFO  : TH[1] : set name of thread 1317609 to TH[1]
2023-01-29 17:07:06: khulnasoft INFO  : TH[2] : set name of thread 1317610 to TH[2]
2023-01-29 17:07:06: khulnasoft INFO  : TH[3] : set name of thread 1317611 to TH[3]
2023-01-29 17:07:06: khulnasoft INFO  : TH[4] : set name of thread 1317612 to TH[4]
2023-01-29 17:07:06: khulnasoft INFO  : TH[5] : set name of thread 1317613 to TH[5]
2023-01-29 17:07:06: khulnasoft INFO  : TH[6] : set name of thread 1317614 to TH[6]
2023-01-29 17:07:06: khulnasoft INFO  : TH[7] : set name of thread 1317615 to TH[7]
...
Waiting the threads to finish...
2023-01-29 17:07:11: khulnasoft INFO  : MAIN : ARAL: did 78427750 malloc, 78427750 free, using 8 threads, in 5088591 usecs
```
...
2023-01-29 17:08:04: khulnasoft INFO  : TH[0] : set name of thread 1318663 to TH[0]
2023-01-29 17:08:04: khulnasoft INFO  : TH[1] : set name of thread 1318664 to TH[1]
2023-01-29 17:08:04: khulnasoft INFO  : TH[2] : set name of thread 1318665 to TH[2]
2023-01-29 17:08:04: khulnasoft INFO  : TH[3] : set name of thread 1318666 to TH[3]
2023-01-29 17:08:04: khulnasoft INFO  : TH[4] : set name of thread 1318667 to TH[4]
2023-01-29 17:08:04: khulnasoft INFO  : TH[5] : set name of thread 1318668 to TH[5]
2023-01-29 17:08:04: khulnasoft INFO  : TH[6] : set name of thread 1318669 to TH[6]
2023-01-29 17:08:04: khulnasoft INFO  : TH[7] : set name of thread 1318670 to TH[7]
2023-01-29 17:08:04: khulnasoft INFO  : TH[8] : set name of thread 1318671 to TH[8]
2023-01-29 17:08:04: khulnasoft INFO  : TH[9] : set name of thread 1318672 to TH[9]
2023-01-29 17:08:04: khulnasoft INFO  : TH[10] : set name of thread 1318673 to TH[10]
2023-01-29 17:08:04: khulnasoft INFO  : TH[11] : set name of thread 1318674 to TH[11]
2023-01-29 17:08:04: khulnasoft INFO  : TH[12] : set name of thread 1318675 to TH[12]
2023-01-29 17:08:04: khulnasoft INFO  : TH[13] : set name of thread 1318676 to TH[13]
2023-01-29 17:08:04: khulnasoft INFO  : TH[14] : set name of thread 1318677 to TH[14]
2023-01-29 17:08:04: khulnasoft INFO  : TH[15] : set name of thread 1318678 to TH[15]
...
Waiting the threads to finish...
2023-01-29 17:08:09: khulnasoft INFO  : MAIN : ARAL: did 65302122 malloc, 65302122 free, using 16 threads, in 5066009 usecs
```
