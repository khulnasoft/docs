---
custom_edit_url: "https://github.com/khulnasoft/khulnasoft/edit/master/src/libkhulnasoft/procfile/README.md"
sidebar_label: "procfile"
docs_status: "Published"
docs_rel_path: "Developer and Contributor Corner/libkhulnasoft"
sidebar_position: "1612140"
docs_link: "https://docs.khulnasoft.com/docs/developer-and-contributor-corner/libkhulnasoft/procfile"
---
...
-   calls `procfile_readall()` to read updated contents.
     ...
     For every file, a [BUFFER](/docs/developer-and-contributor-corner/libkhulnasoft/buffer-library) is used that is automatically adjusted to fit the entire
...
This library is extensively used in Khulnasoft and its plugins.
