---
custom_edit_url: "https://github.com/khulnasoft/khulnasoft/edit/master/src/go/plugin/go.d/docs/how-to-write-a-module.md"
...
sidebar_position: "1606510"
docs_link: "https://docs.khulnasoft.com/docs/developer-and-contributor-corner/external-plugins/go.d.plugin/how-to-write-a-khulnasoft-collector-in-go"
---
...
> [example module](https://github.com/khulnasoft/khulnasoft/tree/master/src/go/plugin/go.d/collector/example), which
> will
...
- Add the source code
  to [`modules/example2/`](https://github.com/khulnasoft/khulnasoft/tree/master/src/go/plugin/go.d/collector).
  - [module interface](#module-interface).
  - [suggested module layout](#module-layout).
  - [helper packages](#helper-packages).
- Add the configuration
  to [`config/go.d/example2.conf`](https://github.com/khulnasoft/khulnasoft/tree/master/src/go/plugin/go.d/config/go.d).
- Add the module
  to [`config/go.d.conf`](https://github.com/khulnasoft/khulnasoft/blob/master/src/go/plugin/go.d/config/go.d.conf).
- Import the module
  in [`modules/init.go`](https://github.com/khulnasoft/khulnasoft/blob/master/src/go/plugin/go.d/collector/init.go).
- Update
  the [`available modules list`](https://github.com/khulnasoft/khulnasoft/tree/master/src/go/plugin/go.d#available-modules).
...
- Run it in the debug mode `bin/godplugin -d -m <MODULE_NAME>`. This will output the `STDOUT` of the collector, the same
  ...
  our [documentation](/docs/developer-and-contributor-corner/external-plugins#external-plugins-api).
- If you want to test the collector with the actual Khulnasoft Agent, you need to replace the `go.d.plugin` binary that
  ...
  you restart the Khulnasoft Agent, it will detect and run it, creating all the charts. It is advised not to remove the default `go.d.plugin` binary, but simply rename it to `go.d.plugin.old` so that the Agent doesn't run it, but you can easily rename it back once you are done.
...
:exclamation: Khulnasoft module
produces [`charts`](/docs/developer-and-contributor-corner/external-plugins#chart), not
raw metrics.

Use [`agent/module`](https://github.com/khulnasoft/khulnasoft/blob/master/src/go/plugin/go.d/agent/module/charts.go)
package to create them,
it contains charts and dimensions structs.

- `Charts` returns
  the [charts](/docs/developer-and-contributor-corner/external-plugins#chart) (`*module.Charts`).
...
> :exclamation: See the
> example [`example.go`](https://github.com/khulnasoft/khulnasoft/blob/master/src/go/plugin/go.d/collector/example/example.go).
...
> :exclamation: See the
> example: [`charts.go`](https://github.com/khulnasoft/khulnasoft/blob/master/src/go/plugin/go.d/collector/example/charts.go).
...
> :exclamation: See the
> example: [`init.go`](https://github.com/khulnasoft/khulnasoft/blob/master/src/go/plugin/go.d/collector/example/init.go).
...
> :exclamation: See the
> example: [`collect.go`](https://github.com/khulnasoft/khulnasoft/blob/master/src/go/plugin/go.d/collector/example/collect.go).
...
> :exclamation: See the
> example: [`example_test.go`](https://github.com/khulnasoft/khulnasoft/blob/master/src/go/plugin/go.d/collector/example/example_test.go).
>
...
There are [some helper packages](https://github.com/khulnasoft/khulnasoft/tree/master/src/go/plugin/go.d/pkg) for
writing a module.
