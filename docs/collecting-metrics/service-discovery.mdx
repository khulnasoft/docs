---
custom_edit_url: "https://github.com/khulnasoft/agent-service-discovery/edit/master/README.md"
...
> [!WARNING]
>
> **Deprecation Notice**: This repository's service discovery functionality has been migrated to go.d.plugin in the main [Khulnasoft repository](https://github.com/khulnasoft/khulnasoft). All future development, maintenance, and updates will continue there.
...
|    [export](#Export)    | Dynamically exports data collection configurations to allow khulnasoft data collection plugins to use them. Data collection jobs in khulnasoft are created and destroyed as needed.   |
