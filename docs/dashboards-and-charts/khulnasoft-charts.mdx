---
custom_edit_url: "https://github.com/khulnasoft/khulnasoft/edit/master/docs/dashboards-and-charts/khulnasoft-charts.md"
sidebar_label: "Khulnasoft Charts"
docs_status: "Published"
docs_rel_path: "Dashboards and Charts"
sidebar_position: "1400030"
docs_link: "https://docs.khulnasoft.com/docs/dashboards-and-charts/khulnasoft-charts"
---

# Khulnasoft Charts

Docs how to use Khulnasoft's powerful charts to troubleshoot with real-time, per-second metric data.

Khulnasoft excels in collecting, storing, and organizing metrics in out-of-the-box dashboards.
To make sense of all the metrics, Khulnasoft offers an enhanced version of charts that update every second.

These charts provide a lot of useful information, so that you can:

- Enjoy the high-resolution, granular metrics collected by Khulnasoft
...
- On highlight, get easy access to [Metric Correlations](/docs/machine-docsing-and-anomaly-detection/metric-correlations) to see other metrics with similar patterns
...
These charts are available on Khulnasoft Cloud's
[Metrics tab](/docs/dashboards-and-charts/metrics-tab-and-single-node-tabs), [single node tabs](/docs/dashboards-and-charts/metrics-tab-and-single-node-tabs) and
on your [Custom Dashboards](/docs/dashboards-and-charts/dashboards-tab).

## Overview

A Khulnasoft chart looks like this:  

<img src="https://user-images.githubusercontent.com/70198089/236133212-353c102f-a6ed-45b7-9251-34e004c7a10a.png"  width="900" alt="A Khulnasoft Chart"/>
...
While Khulnasoft's charts require no configuration and are easy to interact with, they have a lot of underlying complexities. To meaningfully organize charts out of the box based on what's happening in your nodes, Khulnasoft uses the concepts of [dimensions](#dimensions), [contexts](#contexts), and [families](#families).

Understanding how these works will help you more easily navigate the dashboard,
[write new alerts](/docs/alerts-&-notifications/alert-configuration-reference), or play around
with the [API](/docs/developer-and-contributor-corner/rest-api).
...
Khulnasoft also relies on contexts for [alert configuration](/docs/alerts-&-notifications/alert-configuration-reference) (the [`on` line](/docs/alerts-&-notifications/alert-configuration-reference#alert-line-on)).
...
`disk.ops`, `disk.backlog`, and `disk.util`.  If your node has multiple disk drives at `sda` and `sdb`, Khulnasoft creates
a separate family for each.

Khulnasoft now merges the contexts and families to create charts that are grouped by family, following a
`[context].[family]` naming scheme, so that you can see the `disk.io` and `disk.ops` charts for `sda` right next to each
other.

Given the four example contexts, and two families of `sda` and `sdb`, Khulnasoft will create the following charts and their
names:
...
<img src="https://github.com/khulnasoft/khulnasoft/assets/70198089/75d700de-bc7d-4b96-b73d-7b248b83afea" width="900" alt="Khulnasoft Chart Title bar"/>

Title bar elements:

- **Khulnasoft icon**: this indicates that data is continuously being updated, this happens if [Time controls](/docs/dashboards-and-charts/visualization-date-and-time-controls#time-controls) are in Play or Force Play mode.
...
<img src="https://github.com/khulnasoft/khulnasoft/assets/70198089/d21f326e-065c-4a08-bee9-69ad23736e38" width="200" alt="Khulnasoft Chart Title bar immediate actions"/>

- **Manage Alerts**: manage [Alert configurations](/docs/dashboards-and-charts/alerts-tab#alert-configurations-tab) for this chart.
...
- **Drag and Drop the chart to a Dashboard**: add the chart to an existing custom [Dashboard](/docs/dashboards-and-charts/dashboards-tab) or directly create a new one that includes the chart.

## Definition bar

Each composite chart has a definition bar to provide information and options about the following:

<img src="https://user-images.githubusercontent.com/70198089/236134615-e53a1d68-8a0f-466b-b2ef-1974085f0e8d.png" width="900" alt="Khulnasoft Chart Definition bar"/>
...
>  <img src="https://user-images.githubusercontent.com/2662304/235475061-44628011-3b1f-4c44-9528-34452018eb89.png" width="400" border="0" align="center" alt="Khulnasoft NIDL Framework"/>
> </a>
...
<img src="https://user-images.githubusercontent.com/43294513/235470150-62a3b9ac-51ca-4c0d-81de-8804e3d733eb.png" width="900" alt="Khulnasoft Chart NIDL Dropdown menus"/>
...
1. The volume contribution of each metric into the final query. So even if a query comes from 1000 nodes, the contribution of each node in the result can instantly be visualized. The same goes for instances, dimensions and labels. Especially for labels, Khulnasoft also provides the volume contribution of each label `key:value` pair to the final query, so that you can immediately see how much every label value involved in the query affected the chart.
...
<img src="https://user-images.githubusercontent.com/43294513/235468819-3af5a1d3-8619-48fb-a8b7-8e8b4cf6a8ff.png" width="900" alt="Khulnasoft Chart Group by dropdown"/>
...
<img src="https://user-images.githubusercontent.com/70198089/236136725-778670b4-7e81-44a8-8d3d-f38ded823c94.png" width="500" alt="Khulnasoft Chart Aggregate functions over data"/>
...
<img src="https://user-images.githubusercontent.com/70198089/236137765-b57d5443-3d4b-42f4-9e3d-db1eb606626f.png" width="900" alt="Khulnasoft Chart Nodes dropdown"/>
...
networking issues, a stopped `khulnasoft` service, or because that node doesn’t have any metrics for that context.
...
<img src="https://user-images.githubusercontent.com/70198089/236138302-4dd4072e-3a0d-43bb-a9d8-4dde79c65e92.png" width="900" alt="Khulnasoft Chart Instances dropdown"/>
...
<img src="https://user-images.githubusercontent.com/70198089/236138796-08dc6ac6-9a50-4913-a46d-d9bbcedd48f6.png" width="900" alt="Khulnasoft Chart Dimensions Dropdown"/>
...
<img src="https://user-images.githubusercontent.com/70198089/236139027-8a51a958-2074-4675-a41b-efff30d8f51a.png" width="900" alt="Khulnasoft Chart Labels Dropdown"/>
...
<img src="https://user-images.githubusercontent.com/70198089/236411297-e123db06-0117-4e24-a5ac-955b980a8f55.png" width="400" alt="Khulnasoft Chart Aggregate functions over time"/>
...
- Percentile
  - you can specify the percentile you want to focus on: 25th, 50th, 75th, 80th, 90th, 95th, 97th, 98th and 99th.  
    <img src="https://user-images.githubusercontent.com/70198089/236410299-de5f3367-f3b0-4beb-a73f-a49007c543d4.png" width="250" alt="Khulnasoft Chart Aggregate functions over time Percentile selection"/>
- Trimmed Mean or Trimmed Median
  - you can choose the percentage of data that you want to focus on: 1%, 2%, 3%, 5%, 10%, 15%, 20% and 25%.  
    <img src="https://user-images.githubusercontent.com/70198089/236410858-74b46af9-280a-4ab2-ad26-5a6aa9403aa8.png" width="250" alt="Khulnasoft Chart Aggregate functions over time Trimmed Mean or Median selection"/>
- Median
- Standard deviation
...
For more details on each, you can refer to our Agent's HTTP API details on [Data Queries - Data Grouping](/docs/developer-and-contributor-corner/rest-api/queries#data-grouping).
...
Khulnasoft's unsupervised machine docsing algorithm creates a unique model for each metric collected by your Agents, using exclusively the metric's past data.
...
<img src="https://user-images.githubusercontent.com/70198089/236139886-79d63cf6-61ed-4aa7-842c-b5a1728c870d.png" width="900" alt="Khulnasoft Chart Anomaly Rate Ribbon"/>
...
Anomaly Rate visualization doesn’t make Khulnasoft slower. Anomaly rate is saved in the Khulnasoft database, together with metric values, and due to the smart design of Khulnasoft, it doesn’t even incur a disk footprint penalty.
...
<img src="https://user-images.githubusercontent.com/70198089/236141460-bfa66b99-d63c-4a2c-84b1-2509ed94857f.png" width="500" alt="Khulnasoft Chart Hover over Chart"/>
...
<img src="https://user-images.githubusercontent.com/70198089/236145768-8ffadd02-93a4-4e9e-b4ae-c1367f614a7e.png" width="700" alt="Khulnasoft Chart Hover over the chart Info Column"/>

## Play, Pause and Reset

Your charts are controlled using the available [Time controls](/docs/dashboards-and-charts/visualization-date-and-time-controls#time-controls).
...
<img src="https://user-images.githubusercontent.com/70198089/236143292-c1d75528-263d-4ddd-9db8-b8d6a31cb83e.png" width="400" alt="Khulnasoft Chart Tool bar"/>
...
- Running [metric correlations](/docs/machine-docsing-and-anomaly-detection/metric-correlations) to filter metrics that also show something different in the selected period, vs the previous one
...
<img src="https://user-images.githubusercontent.com/70198089/236144658-6c3d0e31-9bcb-45f3-bb95-4eafdcbb0a58.png" width="300" alt="Khulnasoft Chart order dimensions legend"/>
