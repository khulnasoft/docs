---
custom_edit_url: "https://github.com/khulnasoft/khulnasoft/edit/master/docs/dashboards-and-charts/kubernetes-tab.md"
sidebar_label: "Kubernetes tab"
docs_status: "Published"
docs_rel_path: "Dashboards and Charts"
description: "Khulnasoft Cloud features rich, zero-configuration Kubernetes monitoring for the resource utilization and application metrics of Kubernetes (k8s) clusters."
sidebar_position: "1400070"
docs_link: "https://docs.khulnasoft.com/docs/dashboards-and-charts/kubernetes-tab"
---

# Kubernetes tab

The Khulnasoft dashboards feature enhanced visualizations for the resource utilization of Kubernetes (k8s) clusters, embedded in the default [Metrics tab](/docs/dashboards-and-charts/metrics-tab-and-single-node-tabs) dashboard.

These visualizations include a health map for viewing the status of k8s pods/containers, in addition to [Khulnasoft charts](/docs/dashboards-and-charts/khulnasoft-charts) for viewing per-second CPU, memory, disk, and networking metrics from k8s nodes.

See our [Kubernetes deployment instructions](/docs/khulnasoft-agent/installation/kubernetes) for details on deploying Khulnasoft on your Kubernetes cluster.

## Available Kubernetes metrics

Khulnasoft Cloud organizes and visualizes the following metrics from your Kubernetes cluster from every container:
...
When viewing the [overview of this dashboard](#kubernetes-containers-overview), Khulnasoft presents the above metrics per container, or aggregated based on
...
The filtering of this map is controlled by using the [NIDL framework](/docs/dashboards-and-charts/khulnasoft-charts#nidl-framework) from the definition bar of the chart.
