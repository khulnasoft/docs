---
custom_edit_url: "https://github.com/khulnasoft/khulnasoft/edit/master/docs/dashboards-and-charts/visualization-date-and-time-controls.md"
sidebar_label: "Visualization date and time controls"
docs_status: "Published"
docs_rel_path: "Dashboards and Charts"
sidebar_position: "1400140"
docs_link: "https://docs.khulnasoft.com/docs/dashboards-and-charts/visualization-date-and-time-controls"
---

# Visualization date and time controls

Khulnasoft's dashboard features powerful date visualization controls that include a time control, a timezone selector and a rich date and timeframe selector.
...
- You use a terminal or deployment tools to do changes in your infra and want to see the effect immediately; Khulnasoft is in the background, displaying the impact of these changes
- You want to have Khulnasoft in the background, example displayed on a TV, to constantly see metrics through dashboards or to watch the alert status
...
While [panning through time and zooming in/out](/docs/dashboards-and-charts/khulnasoft-charts) from charts, it is helpful when you're looking a recent history, or want to do granular troubleshooting, what if you want to see metrics from 6 hours ago? Or 6 days?

Khulnasoft's dashboard features a **timeframe selector** to help you visualize specific timeframes in a few helpful ways.
...
**You can only see metrics as far back in history as your metrics retention policy allows**. Khulnasoft uses an internal
...
At any time, [configure the internal TSDB's storage capacity](/docs/khulnasoft-agent/configuration/database) to expand your
depth of historical metrics.

### Timezone selector

The default timezone used in all date and time fields in Khulnasoft Cloud comes from your browser. To change it, open the
