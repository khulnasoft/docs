---
custom_edit_url: "https://github.com/khulnasoft/khulnasoft/edit/master/docs/dashboards-and-charts/node-filter.md"
sidebar_label: "Node filter"
docs_status: "Published"
docs_rel_path: "Dashboards and Charts"
sidebar_position: "1400130"
docs_link: "https://docs.khulnasoft.com/docs/dashboards-and-charts/node-filter"
---
...
| Group   | Description                                                                                                                                                                                                                                                                                    |
|---------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Live    | Nodes that are currently online, collecting and streaming metrics to Cloud. Live nodes display raised [Alert](/docs/dashboards-and-charts/alerts-tab) counters, [Machine Docsing](/docs/machine-docsing-and-anomaly-detection/ml-models-and-anomaly-detection) availability, and [Functions](/docs/top-monitoring-khulnasoft-functions) availability |
