---
custom_edit_url: "https://github.com/khulnasoft/khulnasoft/edit/master/docs/dashboards-and-charts/logs-tab.md"
sidebar_label: "Logs tab"
docs_status: "Published"
docs_rel_path: "Dashboards and Charts"
sidebar_position: "1400060"
docs_link: "https://docs.khulnasoft.com/docs/dashboards-and-charts/logs-tab"
---
...
We have a thorough section explaining how you can [work with logs](https://github.com/khulnasoft/khulnasoft/blob/master/docs/category-overview-pages/working-with-logs.md), detailing how the plugin works, and what other utilities are used under the hood to provide you with the visualizations and the log entries.
