---
custom_edit_url: "https://github.com/khulnasoft/khulnasoft/edit/master/docs/dashboards-and-charts/anomaly-advisor-tab.md"
...
sidebar_position: "1400100"
docs_link: "https://docs.khulnasoft.com/docs/dashboards-and-charts/anomaly-advisor-tab"
---

# Anomaly Advisor tab

The Anomaly Advisor tab lets you focus on potentially anomalous metrics and charts related to a particular highlighted window of interest. In addition to this tab, each chart in the [Metrics tab](/docs/dashboards-and-charts/metrics-tab-and-single-node-tabs) also has an [Anomaly Rate ribbon](/docs/dashboards-and-charts/khulnasoft-charts#anomaly-rate-ribbon).

More details about configuration can be found in the [ML documentation](/docs/machine-docsing-and-anomaly-detection/ml-models-and-anomaly-detection).

This tab uses our [Anomaly Rate ML feature](/docs/machine-docsing-and-anomaly-detection/ml-models-and-anomaly-detection#anomaly-bit) to score metrics in terms of anomalous behavior.
...
- If you are interested in a subset of specific nodes, then filtering to just those nodes before highlighting is recommended to get better results. When you highlight a timeframe, Khulnasoft will ask the Agents for a ranking across all metrics, so if there is a subset of nodes, there will be less "averaging" going on, and you'll get a less noisy ranking.
