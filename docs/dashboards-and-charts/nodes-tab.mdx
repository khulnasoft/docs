---
custom_edit_url: "https://github.com/khulnasoft/khulnasoft/edit/master/docs/dashboards-and-charts/nodes-tab.md"
...
sidebar_position: "1400020"
docs_link: "https://docs.khulnasoft.com/docs/dashboards-and-charts/nodes-tab"
---

# Nodes tab

The Nodes tab provides a summarized view of your [Room](/docs/khulnasoft-cloud/spaces-and-rooms#rooms), allowing you to view quick information per node.
...
- View Machine Docsing status
- View Functions capability status
- Add configuration (beta)
- [Add alert silencing rules](/docs/alerts-&-notifications/notifications/centralized-cloud-notifications/manage-alert-notification-silencing-rules)
