---
custom_edit_url: "https://github.com/khulnasoft/khulnasoft/edit/master/docs/khulnasoft-cloud/khulnasoft-cloud-on-prem/troubleshooting.md"
sidebar_label: "Troubleshooting"
docs_status: "Published"
docs_rel_path: "Khulnasoft Cloud/Versions/On-Prem"
sidebar_position: "504530"
docs_link: "https://docs.khulnasoft.com/docs/khulnasoft-cloud/versions/on-prem/troubleshooting"
---

# Khulnasoft Cloud On-Prem Troubleshooting

Khulnasoft Cloud On-Prem is an enterprise-grade monitoring solution that relies on several infrastructure components:
...
```
Installing khulnasoft-cloud-onprem (or khulnasoft-cloud-dependency) helm chart...
[...]
...
1. Check for pods stuck in Pending state:
   ...
   ```shell
   kubectl get pods -n khulnasoft-cloud | grep -v Running
   ```

2. If you find Pending pods, examine the resource constraints:

   ```shell
   kubectl describe pod <POD_NAME> -n khulnasoft-cloud
   ```
...
1. Compare your available resources against the [minimum requirements](/docs/khulnasoft-cloud/versions/on-prem/installation#system-requirements).
...
| Invalid Token Error           | "Something went wrong - invalid token" message          | - Mismatched `khulnasoft-cloud-common` secret<br/>- Database hash mismatch<br/>- Namespace change without secret migration       | - Migrate secret before namespace change<br/>- Perform fresh installation<br/>- Contact support for data recovery                 |

> **Warning**
>
> If you're modifying the installation namespace, the `khulnasoft-cloud-common` secret will be recreated.
>
> **Before proceeding**: Back up the existing `khulnasoft-cloud-common` secret. Alternatively, wipe the PostgreSQL database to prevent data conflicts.
...
2. Contact support at `support@khulnasoft.com`.
