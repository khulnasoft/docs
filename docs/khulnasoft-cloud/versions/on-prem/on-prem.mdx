---
custom_edit_url: "https://github.com/khulnasoft/khulnasoft/edit/master/docs/khulnasoft-cloud/khulnasoft-cloud-on-prem/README.md"
sidebar_label: "On-Prem"
docs_status: "Published"
docs_rel_path: "Khulnasoft Cloud/Versions/On-Prem"
sidebar_position: "504500"
docs_link: "https://docs.khulnasoft.com/docs/khulnasoft-cloud/versions/on-prem/on-prem"
---

# Khulnasoft Cloud On-Prem

Khulnasoft Cloud is built as microservices and is orchestrated by a Kubernetes cluster, providing a highly available and auto-scaled observability platform.

The overall architecture looks like this:

```mermaid
flowchart TD
    Agents("🌍 <b>Khulnasoft Agents</b><br/>Users' infrastructure<br/>Khulnasoft Children & Parents")
    ...
    charts("📈 <b>Metrics & Queries</b><br/>Microservices for<br/>dispatching queries<br/>to Khulnasoft Agents")
