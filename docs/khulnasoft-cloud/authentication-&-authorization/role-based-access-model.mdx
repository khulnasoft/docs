---
custom_edit_url: "https://github.com/khulnasoft/khulnasoft/edit/master/docs/khulnasoft-cloud/authentication-and-authorization/role-based-access-model.md"
sidebar_label: "Role-based access model"
docs_status: "Published"
docs_rel_path: "Khulnasoft Cloud/Authentication & Authorization"
description: "Explanation of Khulnasoft roles and permissions linked to them"
sidebar_position: "507000"
docs_link: "https://docs.khulnasoft.com/docs/khulnasoft-cloud/authentication-&-authorization/role-based-access-model"
---

# Role-Based Access model (RBAC)

Khulnasoft Cloud's Role-Based Access mechanism allows you to control what functionalities a user can access.
...
| **Troubleshooters** can only use Khulnasoft to troubleshoot, not manage entities. They need to be assigned to Rooms in the Space.         | -                  | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark:     |
...
| Edit configuration                                                        | :heavy_check_mark: |         -          |         -          |         -          |         -          | Some exceptions apply depending on [service level](/docs/alerts-&-notifications/notifications/centralized-cloud-notifications/manage-notification-methods#available-actions-per-notification-method-based-on-service-level) |
| Delete configuration                                                      | :heavy_check_mark: |         -          |         -          |         -          |         -          |                                                                                                                                                                                                                                  |
| Edit personal level notification settings                                 | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: | [Manage user notification settings](/docs/alerts-&-notifications/notifications/centralized-cloud-notifications/manage-notification-methods#manage-user-notification-settings)                                               |
...
> **Note**
>
> Enable, Edit and Add actions over specific notification methods will only be allowed if your plan has access to those (see [service classification](/docs/alerts-&-notifications/notifications/centralized-cloud-notifications/centralized-cloud-notifications-reference#service-classification))
...
> **Note**
>
> Khulnasoft Cloud paid subscription required for all actions except "List All".
