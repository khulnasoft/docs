---
custom_edit_url: "https://github.com/khulnasoft/khulnasoft/edit/master/docs/khulnasoft-cloud/view-plan-and-billing.md"
sidebar_label: "Khulnasoft Plans & Billing"
docs_status: "Published"
docs_rel_path: "Khulnasoft Cloud"
sidebar_position: "508000"
docs_link: "https://docs.khulnasoft.com/docs/khulnasoft-cloud/khulnasoft-plans-&-billing"
---

# Khulnasoft Plans & Billing

Khulnasoft offers a **Community plan**, a free SaaS, Open Source Agent, and paid subscriptions — **Homelab**, **Business**, and **Enterprise On-Premise** — providing key business features and unlimited access to your dashboards.

For more info visit the [Khulnasoft Cloud Pricing](https://khulnasoft.com/pricing) page.
...
Khulnasoft Cloud plans (excluding Community) involve:
...
> - Changes may restrict user access in your Space. Review role availability under [each plan](https://khulnasoft.com/pricing).
> - Any credits are valid until the end of the following year.

#### Areas That Change Upon Subscription

Please refer to the [Khulnasoft Cloud Pricing](https://khulnasoft.com/pricing) page for more information on what each plan provides.
...
3. You'll see:
    - **Credit** amount, if applicable, usable for future invoices or subscription changes. More on this at [Plan changes and credit balance](/docs/khulnasoft-cloud/khulnasoft-plans-&-billing#plan-changes-and-credit-balance).
...
Khulnasoft accepts most major Credit/Debit Cards and Bank payments through Stripe and AWS, with more options coming soon.
...
Refunds are available if you cancel your subscription within 14 days of purchase. Request a refund via [billing@khulnasoft.com](mailto:billing@khulnasoft.com).
