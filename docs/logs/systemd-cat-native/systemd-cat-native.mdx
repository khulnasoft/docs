---
custom_edit_url: "https://github.com/khulnasoft/khulnasoft/edit/master/src/libkhulnasoft/log/systemd-cat-native.md"
sidebar_label: "systemd-cat-native"
docs_status: "Published"
docs_rel_path: "Logs/systemd-cat-native"
sidebar_position: "1010000"
docs_link: "https://docs.khulnasoft.com/docs/logs/systemd-cat-native/systemd-cat-native"
---
...
`systemd-cat-native` is a Khulnasoft supplied utility to push structured logs to systemd journals. Key features:
...
- is the standard external logger of Khulnasoft shell scripts
...
![image](https://github.com/khulnasoft/khulnasoft/assets/2662304/689d5e03-97ee-40a8-a690-82b7710cef7c)
...
The result:
![image](https://github.com/khulnasoft/khulnasoft/assets/2662304/faf3eaa5-ac56-415b-9de8-16e6ceed9280)
...
![image](https://github.com/khulnasoft/khulnasoft/assets/2662304/d6037b4a-87da-4693-ae67-e07df0decdd9)
...
```
Khulnasoft systemd-cat-native v1.43.0-333-g5af71b875
...
The program has the following modes of logging:
  ...
  * Log as Khulnasoft, enabled with --log-as-khulnasoft or -N

    In this mode the program uses environment variables set by Khulnasoft for
    the log destination. Only log fields defined by Khulnasoft are accepted.
    If the environment variables expected by Khulnasoft are not found, it
