---
custom_edit_url: "https://github.com/khulnasoft/khulnasoft/edit/master/docs/alerts-and-notifications/notifications/centralized-cloud-notifications/manage-alert-notification-silencing-rules.md"
...
description: "Master Khulnasoft alert management via notification silencing rules for efficient and focused monitoring."
sidebar_position: "1203020"
docs_link: "https://docs.khulnasoft.com/docs/alerts-&-notifications/notifications/centralized-cloud-notifications/manage-alert-notification-silencing-rules"
---
    ...
    1. **Add a new** Alert notification silencing rule configuration.
        ...
        - Define when it is applied:
            ...
            - Scheduled, you can specify the start and end time for when the rule becomes active and then inactive (time is set according to your browser's local timezone).
              Note: You are only able to add a rule if your space is on a [paid plan](/docs/khulnasoft-cloud/khulnasoft-plans-&-billing).
...
| Third party maintenance          | All Rooms          | *        | *                        | `httpcheck_posthog_khulnasoft_cloud.request_status` | *             | *                        | *           | This rule silences this specific Alert since the third-party partner will be undergoing maintenance.                                                                                                                      |
...
| Silence Alert on node            | All Rooms          | `child1` | *                        | `httpcheck_posthog_khulnasoft_cloud.request_status` | *             | *                        | *           | This rule silences the specific Alert on the `child1` node.                                                                                                                                                               |
