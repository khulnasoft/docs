---
custom_edit_url: "https://github.com/khulnasoft/khulnasoft/edit/master/docs/alerts-and-notifications/notifications/centralized-cloud-notifications/manage-notification-methods.md"
...
sidebar_position: "1203010"
docs_link: "https://docs.khulnasoft.com/docs/alerts-&-notifications/notifications/centralized-cloud-notifications/manage-notification-methods"
---
...
> **Notes**
>
> - For Khulnasoft provided ones, you can't delete the existing notification method configuration.
> - Enable, Edit, and Add actions over specific notification methods will only be allowed if your plan has access to those ([service classification](/docs/alerts-&-notifications/notifications/centralized-cloud-notifications/centralized-cloud-notifications-reference#service-classification)).
...
4. You will be presented with a table of the configured notification methods for the Space. You will be able to:
    ...
    - **Delete an existing** notification method configuration. Khulnasoft provided ones can't be deleted, e.g., Email.
...
> **Note**
>
> If an administrator has disabled a Personal [service level](/docs/alerts-&-notifications/notifications/centralized-cloud-notifications/centralized-cloud-notifications-reference#service-level) notification method, this will override any user-specific setting.

### Steps

1. Click on your profile picture and navigate to **Settings** -> **Notifications**
2. You are presented with:
    - The Personal [service level](/docs/alerts-&-notifications/notifications/centralized-cloud-notifications/centralized-cloud-notifications-reference#service-level) notification methods you can manage.
