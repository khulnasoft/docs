---
custom_edit_url: "https://github.com/khulnasoft/khulnasoft/edit/master/docs/alerts-and-notifications/notifications/centralized-cloud-notifications/centralized-cloud-notifications-reference.md"
...
description: "Configure Khulnasoft Cloud to send notifications to your team whenever any node on your infrastructure triggers an alert threshold."
sidebar_position: "1203000"
docs_link: "https://docs.khulnasoft.com/docs/alerts-&-notifications/notifications/centralized-cloud-notifications/centralized-cloud-notifications-reference"
---

# Centralized Cloud Notifications Reference

Khulnasoft Cloud sends Alert notifications for nodes in warning, critical, or unreachable states, ensuring Alerts are managed centrally and efficiently.
...
- Expedite troubleshooting with tools like [Metric Correlations](/docs/machine-docsing-and-anomaly-detection/metric-correlations) and the [Anomaly Advisor](/docs/dashboards-and-charts/anomaly-advisor-tab).
...
> **Note**
>
> Centralized Alerts in Khulnasoft Cloud are separate from the [Khulnasoft Agent](/docs/alerts-&-notifications/notifications) notifications. Agent Alerts must be [configured individually](/docs/alerts-&-notifications/alert-configuration-reference) on each node.
...
Exclusive to [paid plans](/docs/khulnasoft-cloud/khulnasoft-plans-&-billing), includes advanced services like PagerDuty and Slack.

## Alert Notification Silencing Rules

Khulnasoft Cloud offers a silencing rule engine to mute Alert notifications based on specific conditions related to nodes or Alert types. Docs how to manage these settings [here](/docs/alerts-&-notifications/notifications/centralized-cloud-notifications/manage-alert-notification-silencing-rules).

## Flood Protection

If a node repeatedly changes state or raises Alerts, flood protection limits notifications to prevent overload. You can still access node details through Khulnasoft Cloud or directly via the local Agent dashboard.
...
- Calculation or database lookups that Khulnasoft uses to compute the value
