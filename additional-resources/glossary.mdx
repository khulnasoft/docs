...
In this section, you’ll find a list of key terms, their definitions and various concepts associated with Teleflow. Familiarising yourself with these will help you understand and use Teleflow better. They will help you navigate our docs more effectively and utilise Teleflow to its maximum potential.
...
<Frame caption="Channels in Teleflow"><img src="/images/channels.gif" /> </Frame>
## Providers
Providers are responsible for handling message delivery across various channels. Teleflow currently supports multiple notification channels, each with its own set of providers.
   ...
   - Push Notification Providers: This channel includes these providers: 
     ...
     - Pusher Beams
     - Push Webhook
   - In-app Notification Center: Teleflow provides you with a set of APIs and components to create rich customized notification center experiences: 
     - React component
     - Angular component
     - Vue component
     - Web component
...
## Subscribers
Subscribers are entities designated to receive the notifications you send. Each subscriber in Teleflow is uniquely identified by their `subscriberId`.
...
Including actors in event data enables precise tracking and personalization of actions and events in the Teleflow platform.
...
## Organizations
Organizations allow separation of notifications across multiple products, managed through the Teleflow web dashboard.
<Frame caption="Organizations in Teleflow"><img src="/images/org.gif" /> </Frame>

## Environments
Teleflow runs all your requests in the context of an environment. By default, Teleflow creates two environments when your account was created, `development` and `production`.
...
## Team members 
Members of a team have access to the Teleflow web dashboard. This allows you to have individuals work on and manage templates and notifications.
## Layouts 
Layouts are HTML designs or structures to wrap the content of email notifications. Layouts can be manipulated and assigned to new or existing workflows within the Teleflow platform, allowing users to create, manage, and assign these layouts to workflows, so they can be reused to structure the appearance of notifications sent through the platform.
