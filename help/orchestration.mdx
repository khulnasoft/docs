...
Not currently. The Digest duration  can be changed at the Workflow level only and is applied to all subscribers that Workflow is triggered to. If you have an identified use case for this, please let us know at support@teleflow.khulnasoft.com.
