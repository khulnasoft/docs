...
$teleflow->updateNotificationTemplate($templateId, [
  "name" => "name",
  "tags" => ["tags"],
...
teleflow = NotificationTemplateApi(url, api_key).update(
...
public class Main {
    public static void main(String[] args) {
        ...
        teleflow.updateWorkflow(workflowId, body);
    }
}
```
...
```kotlin Kotlin
import co.teleflow.Teleflow
import co.teleflow.extensions.updateWorkflow
