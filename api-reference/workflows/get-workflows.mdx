...
$teleflow->getNotificationTemplates()->toArray();
```
...
teleflow = NotificationTemplateApi(url, api_key).list(
)
```
...
public class Main {
    public static void main(String[] args) {
        ...
        teleflow.getWorkflows(page, limit);
    }
}
```
...
```kotlin Kotlin
import co.teleflow.Teleflow
import co.teleflow.extensions.getWorkflows
