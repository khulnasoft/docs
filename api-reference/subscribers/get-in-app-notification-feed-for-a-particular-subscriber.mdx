...
import co.teleflow.api.subscribers.responses.SubscriberNotificationResponse;
...
public class Main {
   public static void main(String[] args) {
        ...
        SubscriberNotificationResponse response = teleflow.getSubscriberNotificationsFeed(subscriberId);
    }
}
```
</RequestExample>
