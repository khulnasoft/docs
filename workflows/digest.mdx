...
This becomes useful when a user needs to be notified on a large amount of triggers and you want to avoid sending too many notifications. Teleflow will automatically batch the incoming trigger events based on the `subscriberId` and an **optional** `digestKey` that can be added to control the digestion of the events.
...
<Frame caption="Digest Nodes"><img src="https://github.com/khulnasoft/docs/assets/2946769/3fa668ea-0f94-49f9-9784-211db64a7a36" /></Frame>
...
<Frame caption="Digest Key"><img src="https://github.com/khulnasoft/docs/assets/2946769/a9c4c1a5-ecd7-414e-aa63-ec7f340f95fb" /></Frame>
...
<Frame caption="Time interval"><img src="https://github.com/khulnasoft/docs/assets/2946769/f78b31e2-8bbf-444c-823d-30749669d9e5" /></Frame>

## Digest Strategy Types

The strategy which Teleflow should use to handle the digest step. More details on available strategies below.

Teleflow allows you to define different digest strategies depending on the actual use-case you are trying to achieve. At this point we allow you to select from 2 strategies:
...
In the back-off strategy, before creating a digest, Teleflow will check if a message was sent to the user in the back-off period. If a message was sent, a digest will be created. Otherwise, a message will be sent directly to the user and the digest creation will be skipped.
...
<Frame caption="Back-off Strategy"><img src="https://github.com/khulnasoft/docs/assets/2946769/06708bd4-bb1d-49b3-b297-fd2070c2e4fe" /></Frame>
...
<Frame caption="Scheduled Digest in Minutes"><img src="https://github.com/khulnasoft/docs/assets/2946769/4b50ab88-ae3c-405d-b206-93d734b6561a" /></Frame>

**Hour:**

It digests events for given hours. After given hours, a new digest is created.

<Frame caption="Scheduled Digest in Hours"><img src="https://github.com/khulnasoft/docs/assets/2946769/ed3d8cc2-ec71-4dc2-be84-51a33b43e0e3" /></Frame>
...
<Frame caption="Scheduled Digest Daily"><img src="https://github.com/khulnasoft/docs/assets/2946769/8d37a085-2583-4aea-a29c-8c04aaad7be7" /></Frame>
...
<Frame caption="Scheduled Digest Weekly"><img src="https://github.com/khulnasoft/docs/assets/2946769/f5331c48-76e8-49b4-b977-7a45fca8e4ed" /></Frame>

**Monthly:**

<Frame caption="Scheduled Digest Monthly"><img src="https://github.com/khulnasoft/docs/assets/2946769/6db92aed-8dcb-4f23-a19d-481881bf7a8d" /></Frame>
...
```tsx
teleflow.trigger('workflow-name', {
  to: '123',
  payload: {
    name: 'Hello',
  },
