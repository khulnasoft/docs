...
<script>
  (function (n, o, t, i, f) {
    ...
    window,
    document,
    "https://embed.teleflow.khulnasoft.com/embed.umd.min.js",
    "teleflow",
    "script"
  );
...
```html
<script>
  teleflow.on("notification_click", (notification) => {
    // do custom logic here
  });

  teleflow.on("action_click", ({ templateIdentifier, type, notification }) => {
    // do custom logic here
  });
</script>
```
...
[![Edit teleflow-iframe-nc](https://codesandbox.io/static/img/play-codesandbox.svg)](https://codesandbox.io/s/teleflow-iframe-nc-t9ns9d?fontsize=14&hidenavigation=1&theme=dark)
