---
title: 'How to send push notifications to Flutter apps (Android & iOS) with FCM using Teleflow'
description: 'Learn how to integrate Firebase Cloud Messaging with Teleflow and send notifications to Flutter apps'
---
...
- [Teleflow](https://web.teleflow.khulnasoft.com/?utm_campaign=docs-gs-guides-fcm-flutter) account.
...
Check out the [Flutter app code for this guide on GitHub](https://github.com/khulnasoft/flutter-fcm-teleflow).
...
<Frame caption="Running the app to build on my device">
  <img src="https://github.com/khulnasoft/docs/assets/2946769/71ebea0f-f4fd-49ba-b6ee-591950dd251d"/>
</Frame>
<br />
<Frame caption="Notification Permission Prompt">
  <img src="https://github.com/khulnasoft/docs/assets/2946769/907564e3-6d93-4d0a-881c-792cbb471665"/>
</Frame>
<br />
<Frame caption="Flutter app running waiting to receive push notifications">
  <img src="https://github.com/khulnasoft/docs/assets/2946769/e1c4bfb7-9cfa-421a-820b-53f4bfe2ab65"/>
</Frame>
...
<Frame caption="Yaay! Push Notification from FCM on my device">
  <img src="https://github.com/khulnasoft/docs/assets/2946769/a8d83c16-a016-4c81-9375-9e0cecd202f2"/>
</Frame>

## Sign Up on Teleflow

Let's use Teleflow to fire push notifications via FCM. First, sign up on [Teleflow Cloud](https://web.teleflow.khulnasoft.com)?utm_campaign=docs-gs-guides-fc-flutter.
...
A subscriber is essentially the recipient of the notifications sent through Teleflow's system. When you create a subscriber, you're setting up the necessary information for Teleflow to send targeted notifications to that individual.

You can see the list of subscribers in the `Subscribers` section of the Teleflow dashboard.
...
```
    ...
    <Frame><img src="https://github.com/khulnasoft/docs/assets/2946769/e844e408-d6f6-47f4-ad89-4e8481b17e95"/> </Frame>

  </Step>

  <Step title="Grab the FCM device token from your Editor log">
    <Frame><img src="https://github.com/khulnasoft/docs/assets/2946769/c0d1117e-6545-4c57-b463-3c25e3b165f3"/> </Frame>
  </Step>
...
## Sending a Push Notification to a Device(Android/iOS) with Teleflow

To send a notification with Teleflow, you are actually triggering a notification workflow. 
You have the ability to test the trigger using the Teleflow UI or by calling Teleflow's API.
...
curl --location --request POST 'https://api.teleflow.khulnasoft.com/v1/events/trigger' \
     ...
     --header 'Content-Type: application/json' \
     --data-raw '{
         "name": "teleflow-push-workflow-for-flutter",
         "to": {
...
**Trigger a workflow via the Teleflow Dashboard**

<Frame caption="Add Push title and content"><img src="https://github.com/khulnasoft/docs/assets/2946769/e6f5aefb-4abe-4190-8d94-16f31650427d"/> </Frame>
<Frame caption="Trigger Workflow"><img src="https://github.com/khulnasoft/docs/assets/2946769/cfa2e904-f07a-4796-9020-6917fdb17aa8"/> </Frame>

**Receive Triggered Push Workflow on Device**

<Frame caption="Push Notification Received on the Device">
  <img src="https://github.com/khulnasoft/docs/assets/2946769/741dc520-1b0e-429e-bcf8-165536ef5dd4
"/> 
</Frame>
...
<Frame><img src="https://github.com/khulnasoft/docs/assets/2946769/03c268b1-8c7a-4c8b-9a67-b4a401139bd4"/> </Frame>
...
<Frame caption="Push Notification received on device from Teleflow via FCM"><img src="https://github.com/khulnasoft/docs/assets/2946769/b7a2d4b2-003b-423a-856c-207072f0bed6"/> </Frame>
...
<Frame caption="Push & Data Notification received on device in the foreground from Teleflow via FCM">
  <img src="https://github.com/khulnasoft/docs/assets/2946769/cac3d859-578e-4df5-9601-9a4a32398688"/>
</Frame>
