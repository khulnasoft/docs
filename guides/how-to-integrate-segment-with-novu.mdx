---
title: 'How To Integrate Segment With Teleflow'
description: ''
---
...
frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen>
  ...
  <Step title="Personalized Notification with Teleflow">
    - Teleflow is used to craft and send personalized notifications to these segmented groups.
...
<Frame caption="Example of a special offer email in Teleflow's email editor">
...
<Frame caption="Example of an 'Abandoned Cart Recovery' workflow in Teleflow">
...
## Setting Teleflow as a Destination

As of <Tooltip tip="November 16th, 2023">today</Tooltip> Segment doesn’t have a native Teleflow Destination integration **yet** .
...
<Tip>
If you you need an example of Teleflow destination function, you can find it in [here](https://github.com/khulnasoft/segment-teleflow-destination-scripts).
Feel free to submit your function examples as well!
</Tip>

### Sending a payload to Teleflow

Now let's learn how to send a payload to Teleflow based on the `onTrack` event function:

To successfully send a payload to Teleflow, triggering the appropriate [workflow](/getting-started/concepts#workflow) and delivering it to the correct customer, please ensure that you provide the following information:

1. Teleflow's Workflow Identifier.
2. Subscriber ID (Please ensure that the Subscriber ID is both unique and consistent across all of your databases).
3. Your Teleflow API Key.
4. [Teleflow's Event Trigger API Endpoint](https://api.teleflow.khulnasoft.com/events/trigger)
...
async function onTrack(event, settings) {
	...
	const endpoint = settings.teleflowEndpoint;
	console.log('endpoint:', endpoint);

	const ApiKey = settings.teleflowApiKey; // Your TELEFLOW API key
...
<Frame>
  <img src="/images/guides/segment-teleflow-integration/settings-tab-empty.png" />
</Frame>

Click `Add Setting` to add your new setting.

<Frame>
  <img src="/images/guides/segment-teleflow-integration/add-setting-dialog.png" />
</Frame>
...
<Frame caption="The variables you need to run the provided snippit">
  <img src="/images/guides/segment-teleflow-integration/teleflow-segment-settings-variables.png" />
</Frame>
...
<Frame caption="Example from Segment's documention event sources">
  <img src="/images/guides/segment-teleflow-integration/autofill-events.gif" />
</Frame>
...
<Frame>
  <img src="/images/guides/segment-teleflow-integration/custom-segment-event.gif" />
</Frame>
...
We will now execute the function based on the manual event input we've provided. This function sends a trigger to Teleflow, prompting to take action and send the user an email to return and the purchase.

<Frame>
  <img src="/images/guides/segment-teleflow-integration/running-segment-func-for-teleflow-destination.gif" />
</Frame>

Whether you chose the first or second option to test your Destination Function, you can also check if the function triggered your workflow and whether it was delivered through Teleflow's [Activity Feed](https://web.teleflow.khulnasoft.com/activities?utm_campaign=docs-guides-segment).

<Frame>
  <img src="/images/guides/segment-teleflow-integration/activity-feed.gif" />
</Frame>
...
- https://aviyel.com/post/3381/how-to-integrate-teleflow-with-segment
