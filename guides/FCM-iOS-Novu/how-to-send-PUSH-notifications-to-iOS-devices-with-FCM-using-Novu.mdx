---
title: 'How to send PUSH notifications to iOS devices with FCM using Teleflow'
description: 'Learn how to integrate Firebase Cloud Messaging with Teleflow and send notifications to iOS'
---
...
- [Teleflow](https://web.teleflow.khulnasoft.com/?utm_campaign=docs-gs-guides-fcm-ios) account
...
<Frame><img src="/guides/FCM-iOS-Teleflow/Assets/1.png"/> </Frame>
<Frame><img src="/guides/FCM-iOS-Teleflow/Assets/2.png"/> </Frame>
<Frame><img src="/guides/FCM-iOS-Teleflow/Assets/3.png"/> </Frame>
<Frame><img src="/guides/FCM-iOS-Teleflow/Assets/4.png"/> </Frame>
<Frame><img src="/guides/FCM-iOS-Teleflow/Assets/5.png"/> </Frame>

Let's build and run our iOS application to see if everything works correctly.

<Frame><img src="/guides/FCM-iOS-Teleflow/Assets/6.png"/> </Frame>
...
<Frame><img src="/guides/FCM-iOS-Teleflow/Assets/7.png"/> </Frame>

Go to iOS+ and click on the `Set up an Apple platforms client` section.

<Frame><img src="/guides/FCM-iOS-Teleflow/Assets/8.png"/> </Frame>
...
<Frame><img src="/guides/FCM-iOS-Teleflow/Assets/9.png"/> </Frame>
<Frame><img src="/guides/FCM-iOS-Teleflow/Assets/10.png"/> </Frame>
<Frame><img src="/guides/FCM-iOS-Teleflow/Assets/11.png"/> </Frame>
<Frame><img src="/guides/FCM-iOS-Teleflow/Assets/12.png"/> </Frame>

## Create a Firebase project

Select a name for your project.

<Frame><img src="/guides/FCM-iOS-Teleflow/Assets/13.png"/> </Frame>

Then, add Google Analytics to the Firebase project.

<Frame><img src="/guides/FCM-iOS-Teleflow/Assets/14.png"/> </Frame>

Here, you can select your Google account.

<Frame><img src="/guides/FCM-iOS-Teleflow/Assets/15.png"/> </Frame>
<Frame><img src="/guides/FCM-iOS-Teleflow/Assets/16.png"/> </Frame>

We will click on Add Firebase to your iOS app.

<Frame><img src="/guides/FCM-iOS-Teleflow/Assets/17.png"/> </Frame>

We first need to add the bundle name, so go to your iOS Xcode project and copy and paste the bundle name.

<Frame><img src="/guides/FCM-iOS-Teleflow/Assets/18.png"/> </Frame>
<Frame><img src="/guides/FCM-iOS-Teleflow/Assets/19.png"/> </Frame>

Download the `.plist` file and put it in the root of your project.

<Frame><img src="/guides/FCM-iOS-Teleflow/Assets/20.png"/> </Frame>
<Frame><img src="/guides/FCM-iOS-Teleflow/Assets/21.png"/> </Frame>

You can put it right under `info.plist` file.

<Frame><img src="/guides/FCM-iOS-Teleflow/Assets/22.png"/> </Frame>
...
<Frame><img src="/guides/FCM-iOS-Teleflow/Assets/23.png"/> </Frame>
<Frame><img src="/guides/FCM-iOS-Teleflow/Assets/24.png"/> </Frame>
<Frame><img src="/guides/FCM-iOS-Teleflow/Assets/25.png"/> </Frame>
<Frame><img src="/guides/FCM-iOS-Teleflow/Assets/26.png"/> </Frame>
<Frame><img src="/guides/FCM-iOS-Teleflow/Assets/27.png"/> </Frame>
<Frame><img src="/guides/FCM-iOS-Teleflow/Assets/28.png"/> </Frame>
...
<Frame><img src="/guides/FCM-iOS-Teleflow/Assets/29.png"/> </Frame>
...
<Frame><img src="/guides/FCM-iOS-Teleflow/Assets/30.png"/> </Frame>
<Frame><img src="/guides/FCM-iOS-Teleflow/Assets/31.png"/> </Frame>

Let's build and run our project and see if we get Firebase log messages in the console.

<Frame><img src="/guides/FCM-iOS-Teleflow/Assets/32.png"/> </Frame>
<Frame><img src="/guides/FCM-iOS-Teleflow/Assets/33.png"/> </Frame>
...
<Frame><img src="/guides/FCM-iOS-Teleflow/Assets/34.png"/> </Frame>
...
<Frame><img src="/guides/FCM-iOS-Teleflow/Assets/35.png"/> </Frame>

Create a new key.

<Frame><img src="/guides/FCM-iOS-Teleflow/Assets/36.png"/> </Frame>

Select "Apple Push Notification Service".

<Frame><img src="/guides/FCM-iOS-Teleflow/Assets/37.png"/> </Frame>

Click "Register".

<Frame><img src="/guides/FCM-iOS-Teleflow/Assets/38.png"/> </Frame>

We have to download this key and upload it into Firebase.

<Frame><img src="/guides/FCM-iOS-Teleflow/Assets/39.png"/> </Frame>

Head to "Project Settings".

<Frame><img src="/guides/FCM-iOS-Teleflow/Assets/40.png"/> </Frame>

Click on Cloud Messaging, then click "Upload APNs Authentication Key".

<Frame><img src="/guides/FCM-iOS-Teleflow/Assets/41.png"/> </Frame>

Now we can upload the dots p8 file.

<Frame><img src="/guides/FCM-iOS-Teleflow/Assets/42.png"/> </Frame>

You must enter your `Key ID` and `Team ID`, which you can find in the top right corner.

<Frame><img src="/guides/FCM-iOS-Teleflow/Assets/43.png"/> </Frame>
<Frame><img src="/guides/FCM-iOS-Teleflow/Assets/44.png"/> </Frame>

## Register for Remote Notifications 

<Frame><img src="/guides/FCM-iOS-Teleflow/Assets/45.png"/> </Frame>
...
<Frame><img src="/guides/FCM-iOS-Teleflow/Assets/46.png"/> </Frame>
<Frame><img src="/guides/FCM-iOS-Teleflow/Assets/47.png"/> </Frame>

We will now add a 'Messaging' delegate extension to `AppDelegate.swift` file.

<Frame><img src="/guides/FCM-iOS-Teleflow/Assets/48.png"/> </Frame>
...
<Frame><img src="/guides/FCM-iOS-Teleflow/Assets/49.png"/> </Frame>
...
<Frame><img src="/guides/FCM-iOS-Teleflow/Assets/50.png"/> </Frame>

Click on the plus sign (+) and select `Background Modes`.

<Frame><img src="/guides/FCM-iOS-Teleflow/Assets/51.png"/> </Frame>
...
<Frame><img src="/guides/FCM-iOS-Teleflow/Assets/52.png"/> </Frame>

Add `Push Notifications` capabilities.

<Frame><img src="/guides/FCM-iOS-Teleflow/Assets/53.png"/> </Frame>

## App Build

<Frame><img src="/guides/FCM-iOS-Teleflow/Assets/54.png"/> </Frame>

It will ask if you want to receive notifications, and we will allow it.

<Frame><img src="/guides/FCM-iOS-Teleflow/Assets/55.png"/> </Frame>

## Cloud Message Test

In your Firebase project, navigate to 'engage' section and click on 'messaging'.

<Frame><img src="/guides/FCM-iOS-Teleflow/Assets/56.png"/> </Frame>

Click on "Send your first message".

<Frame><img src="/guides/FCM-iOS-Teleflow/Assets/57.png"/> </Frame>
<Frame><img src="/guides/FCM-iOS-Teleflow/Assets/58.png"/> </Frame>

We're going to enter the `notification title` and the `notification text`, then we're going to send the test message.

<Frame><img src="/guides/FCM-iOS-Teleflow/Assets/59.png"/> </Frame>
...
<Frame><img src="/guides/FCM-iOS-Teleflow/Assets/60.png"/> </Frame>
<Frame><img src="/guides/FCM-iOS-Teleflow/Assets/61.png"/> </Frame>
<Frame><img src="/guides/FCM-iOS-Teleflow/Assets/62.png"/> </Frame>

Click on 'Test'.

<Frame><img src="/guides/FCM-iOS-Teleflow/Assets/63.png"/> </Frame>

You should see the notification on your device!

<Frame><img src="/guides/FCM-iOS-Teleflow/Assets/64.png"/> </Frame>

## Teleflow account creation

<Frame><img src="/guides/FCM-iOS-Teleflow/Assets/65.png"/> </Frame>

You can immediately configure FCM as a Push channel provider or navigate to the Integration Store.

<Frame><img src="/guides/FCM-iOS-Teleflow/Assets/66.png"/> </Frame>

## Connecting FCM as a provider

<Frame><img src="/guides/FCM-iOS-Teleflow/Assets/67.png"/> </Frame>
<Frame><img src="/guides/FCM-iOS-Teleflow/Assets/68.png"/> </Frame>

You only need to configure FCM with Teleflow with the Firebase Service Accounts private key. 
...
6. Once the file is on your machine, paste the entire JSON file content in the Service Account field of the FCM provider in the integration store on Teleflow’s web dashboard.
...
<Frame><img src="/guides/FCM-iOS-Teleflow/Assets/69.png"/> </Frame>
<Frame><img src="/guides/FCM-iOS-Teleflow/Assets/70.png"/> </Frame>
<Frame><img src="/guides/FCM-iOS-Teleflow/Assets/71.png"/> </Frame>
<Frame><img src="/guides/FCM-iOS-Teleflow/Assets/72.png"/> </Frame>
<Frame><img src="/guides/FCM-iOS-Teleflow/Assets/73.png"/> </Frame>

## Creating a workflow

In Teleflow, creating a workflow means establishing a blueprint for sending notifications within your app. This unified structure ties together email, in-app messages, SMS, push notifications, and chat into **one entity**.
...
<Steps>
  <Step title="Nabigate to 'Workflows' tab and click on 'Blank Workflow'">
    <Frame><img src="/guides/FCM-iOS-Teleflow/Assets/74.png"/> </Frame>
    <Frame><img src="/guides/FCM-iOS-Teleflow/Assets/75.png"/> </Frame>
  </Step>
  <Step title="Add (Drag & Drop) the Push channel node to the workflow">
  <Frame><img src="/guides/FCM-iOS-Teleflow/Assets/76.png"/> </Frame>
  </Step>
  <Step title="Click on the node, and start to modify the content. Once you are done, click on 'Update'">
    <Frame><img src="/guides/FCM-iOS-Teleflow/Assets/77.png"/> </Frame>
  </Step>
</Steps>

## Creating a subscriber

Creating a subscriber in Teleflow refers to the process of establishing a subscriber entity within the Teleflow platform. A subscriber is essentially the recipient of the notifications sent through Teleflow's system. When you create a subscriber, you're setting up the necessary information for Teleflow to send targeted notifications to that individual.

<Frame><img src="/guides/FCM-iOS-Teleflow/Assets/78.png"/> </Frame>
...
```
    ...
    <Frame><img src="/guides/FCM-iOS-Teleflow/Assets/79.png"/> </Frame>

  </Step>

  <Step title="Locating subscriber's FCM registration token">
    <Frame><img src="/guides/FCM-iOS-Teleflow/Assets/80.png"/> </Frame>
  </Step>
  ...
  <Frame><img src="/guides/FCM-iOS-Teleflow/Assets/81.png"/> </Frame>

```JSON

    curl --request PUT \
  --url https://api.teleflow.khulnasoft.com/v1/subscribers/{subscriber_id}/credentials \
--header 'Content-Type: application/json' \
  --header 'Authorization: ApiKey <YOUR_API_KEY>' \
  --data '{
  "credentials":{
...
## Sending a notification to iOS device with Teleflow

To send a notification with Teleflow, you are actually triggering a notification workflow. 
You have the ability to test the trigger using the user interface or by calling Teleflow's API.

**Trigger a workflow via the API**

```JSON

curl --location --request POST 'https://api.teleflow.khulnasoft.com/v1/events/trigger' \
...
<Frame><img src="/guides/FCM-iOS-Teleflow/Assets/82.png"/> </Frame>
...
<Frame><img src="/guides/FCM-iOS-Teleflow/Assets/83.png"/> </Frame>
...
<Frame><img src="/guides/FCM-iOS-Teleflow/Assets/84.png"/> </Frame>
...
curl --location --request POST 'https://api.teleflow.khulnasoft.com/v1/events/trigger' \
     ...
     --data-raw '{
         ...
         "payload": {
           ...
           "body": "Hello World from Teleflow"
         },
         "overrides": {
           "fcm": {
             "apns": {
...
<Frame><img src="/guides/FCM-iOS-Teleflow/Assets/85.png"/> </Frame>
<Frame><img src="/guides/FCM-iOS-Teleflow/Assets/86.png"/> </Frame>
<Frame><img src="/guides/FCM-iOS-Teleflow/Assets/87.png"/> </Frame>

Select **Finish**, and when prompted, select **Activate**.

<Frame><img src="/guides/FCM-iOS-Teleflow/Assets/88.png"/> </Frame>
...
<Frame><img src="/guides/FCM-iOS-Teleflow/Assets/89.png"/> </Frame>

Select the + button, and search for FirebaseMessaging. Then, select Add.

<Frame><img src="/guides/FCM-iOS-Teleflow/Assets/90.png"/> </Frame>
<Frame><img src="/guides/FCM-iOS-Teleflow/Assets/91.png"/> </Frame>
...
<Frame><img src="/guides/FCM-iOS-Teleflow/Assets/92.png"/> </Frame>
...
<Frame><img src="/guides/FCM-iOS-Teleflow/Assets/93.png"/> </Frame>
<Frame><img src="/guides/FCM-iOS-Teleflow/Assets/94.png"/> </Frame>
...
<Frame><img src="/guides/FCM-iOS-Teleflow/Assets/95.png"/> </Frame>
