...
sidebarTitle: 'APNS'
description: 'Learn how to use the Apple Push Notification Service (APNS) provider to send push notifications using Teleflow'
---
...
await teleflow.subscribers.setCredentials('subscriberId', PushProviderIdEnum.APNS, {
