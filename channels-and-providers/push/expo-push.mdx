---
title: 'Expo Push'
description: 'Learn how to use the Expo push provider to send push notifications using Teleflow'
---
...
```javaScript
import {
  Teleflow,PushProviderIdEnum
} from '@teleflow/node';

const teleflow = new Teleflow("<TELEFLOW_API_KEY>");

await teleflow.subscribers.setCredentials('subscriberId', PushProviderIdEnum.EXPO, {
