---
title: 'Telnyx'
description: 'Learn how to use the Telnyx provider to send sms notifications using Teleflow'
---

You can use the [Telnyx](https://telnyx.com/) provider to send transactional emails to your customers using the Teleflow Platform with a single API to create multi-channel experiences.

# Getting Started

To use the Telnyx provider in the SMS channel, you will need to create a Telnyx account and add your API key to the Telnyx integration on the Teleflow platform.
...
# Creating a Telnyx integration with Teleflow

- Visit the [Integrations](https://web.teleflow.khulnasoft.com/integrations) page on the Teleflow.
...
- You should now be able to send notifications using Telnyx in Teleflow.