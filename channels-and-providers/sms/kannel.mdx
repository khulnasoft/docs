---
title: 'Kannel'
description: 'Learn how to use the Kannel sms provider to send sms notifications using Teleflow'
---

Before integrating Kannel with Teleflow, you should have Kannel set up and configured as an SMS gateway on your server. Let’s look at how you can do that:
...
# Creating a Kannel integration with Teleflow

  After setting up your Kannel, follow these steps to integrate with teleflow:

- Visit the [Integrations Store](https://web.teleflow.khulnasoft.com/integrations?utm_campaign=docs-sms-kannel) on Teleflow.
...
- Once the integration is active, you'll need to configure it. This configuration usually involves providing the necessary details for Teleflow to connect to your Kannel SMS gateway. These details typically include:
  ...
  - **Port**: The port number through which Teleflow should communicate with Kannel (usually 13013, or a custom port you've configured in Kannel).
...
- You should now be able to send notifications using Kannel in Teleflow.
