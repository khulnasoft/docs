---
title: 'Twilio'
description: 'Learn how to use the Twilio provider to send sms notifications using Teleflow'
---
...
# Creating a Twilio integration with Teleflow

Creating a Twilio integration with Teleflow is quite simple. Just follow these steps:

- Visit the [Integrations Store](https://web.teleflow.khulnasoft.com/integrations) on Teleflow.
...
- You should now be able to send SMS notifications using **Twilio** in Teleflow.