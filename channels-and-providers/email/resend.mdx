---
title: 'Resend'
description: 'Learn how to use the Resend provider to send email notifications using Teleflow'
---

You can use the [Resend](https://resend.com/) provider to send transactional emails to your customers using the Teleflow Platform with a single API to create multi-channel experiences.

# Getting Started

To use the Resend provider in the email channel, you will need to create a Resend account and add your API key to the Resend integration on the Teleflow platform.
...
# Creating a Resend integration with Teleflow

- Visit the [Integrations](https://web.teleflow.khulnasoft.com/integrations?utm_campaign=docs-resend) page on Teleflow.
...
- You should now be able to send notifications using Resend in Teleflow.