---
title: 'Mailtrap'
description: 'Learn how to use the Mailtrap provider to send email notifications using Teleflow'
---

You can use the [Mailtrap](https://mailtrap.io/email-sending/) provider to send transactional emails to your customers using the Teleflow Platform with a single API to create multi-channel experiences.

# Getting Started

To use the Mailtrap provider in the email channel, you will need to create a Mailtrap account and add your API key to the Mailtrap integration on the Teleflow platform.
...
# Creating a Mailtrap integration with Teleflow

- Visit the [Integrations store](https://web.teleflow.khulnasoft.com/integrations?utm_campaign=docs-mailtrap) on the Teleflow web dashboard.
...
- You should now be able to send notifications through Mailtrap using Teleflow.
