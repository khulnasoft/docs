---
title: 'Mailgun'
description: 'Learn how to use the Mailgun provider to send email notifications using Teleflow'
---

You can use the [Mailgun](https://mailgun.com/) provider to send transactional emails to your customers using the Teleflow Platform with a single API to create multi-channel experiences.

# Getting Started

To use the Mailgun provider in the email channel, you will need to create a Mailgun account and add your API key and domain name to the Mailgun integration on the Teleflow platform.
...
# Creating a Mailgun integration with Teleflow

- Visit the [Integrations](https://web.teleflow.khulnasoft.com/integrations?utm_campaign=docs-mailgun) page on Teleflow.
...
- You should now be able to send notifications using Mailgun in Teleflow.