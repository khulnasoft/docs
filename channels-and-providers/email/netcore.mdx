---
title: 'Netcore'
description: 'Learn how to use the Netcore provider to send email notifications using Teleflow'
---

You can use the [Netcore](https://netcorecloud.com/) provider to send transactional emails to your customers using the Teleflow Platform with a single API to create multi-channel experiences.

# Getting Started

To use the Netcore provider in the email channel, you will need to create a Netcore account and add your API key to the Netcore integration on the Teleflow platform.
...
# Creating a Netcore integration with Teleflow

- Visit the [Integrations](https://web.teleflow.khulnasoft.com/integrations?utm_campaign=docs-netcore) page on Teleflow.
...
- You should now be able to send notifications using Netcore in Teleflow.