---
title: 'Email Webhook'
description: 'Learn how to use the Email Webhook provider to send email notifications using Teleflow'
---
...
First go to [Email Settings](https://web.teleflow.khulnasoft.com/settings/email?utm_campaign=docs-webhook) in Settings menu to configure Email Webhook. 

# Creating the Email Webhook integration with Teleflow

- Visit the [Integrations](https://web.teleflow.khulnasoft.com/integrations?utm_campaign=docs-webhook) page on Teleflow.
...
- You should now be able to send notifications using Email Webhook in Teleflow.