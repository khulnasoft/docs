---
title: 'Sendinblue'
description: 'Learn how to use the Sendinblue provider to send email notifications using Teleflow'
---

You can use the [Sendinblue](https://www.sendinblue.com/) provider to send transactional emails to your customers using the Teleflow Platform with a single API.

# Getting Started

To use the Sendinblue provider in the email channel, you will need to create a Sendinblue account and add your API key to the Sendinblue integration on the Teleflow platform.
...
# Creating a Sendinblue integration with Teleflow

- Visit the [Integrations store](https://web.teleflow.khulnasoft.com/integrations?utm_campaign=docs-sendinblue) on the Teleflow web dashboard.
...
- You should now be able to send notifications using Sendinblue in Teleflow.

## Using Sendinblue template

Teleflow has its own email editor for writing email template. If you want to use pre made template from Sendinblue, you can use `customData` filed of email overrides to send template details. Make sure your `Api Key` has enough permission to read and process the template.
