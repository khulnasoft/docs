...
<head>
    <meta charset="UTF-8">
    <title>Welcome to Teleflow!</title>
    <style>
...
<body>
    <div class="container">
        <div class="header">
            <h1 style="color: #007bff;">Welcome to Teleflow!</h1>
        </div>
        <div class="message">
        ...
        <div class="signature">
            <p>Best regards,<br>Your friends at Teleflow</p>
        </div>
    </div>
</body>
</html>
...
<Info>Email Subject, Sender Name and Preheader field accepts system, payload variables and handlebar helpers</Info>
...
<img
  style={{ borderRadius: "0.5rem" }}
  src="/images/content-creation-design/push-editor.png"
/>
